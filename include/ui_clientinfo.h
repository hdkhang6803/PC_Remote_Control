...
public:
    ...
    void setupUi(QMainWindow *clientInfo)
    {
        ...
        connectWidget->setGeometry(QRect(230, 70, 841, 461));
...
"background-color: #F2F6FC;"));
        ...
        IDinput->setGeometry(QRect(130, 100, 561, 51));
...
"border: none;"));
        ...
        portLabel->setGeometry(QRect(130, 180, 251, 20));
...
"color: #ffffff;"));
        ...
        pushButton_2->setGeometry(QRect(430, 370, 111, 41));
...
""));
        ...
        failLabel->setGeometry(QRect(260, 310, 321, 31));
        failLabel->setStyleSheet(QString::fromUtf8("font: bold 600 10pt \"UTM Avo\";\n"
"color: rgb(170, 0, 0);\n"
"border: none;\n"
"text-align: justify;"));
        ...
        menubar->setGeometry(QRect(0, 0, 1343, 26));
